...
- **界面版本 38**：敌方骷髅王不再主动自杀触发重生；敌方主动装备按血量、距离、充能及冷却等条件行动。第 20 / 30 关 Boss 最大生命分别提高到 20,000 / 32,000，并增加攻击、护甲与魔抗；第 11、16、21、26 关全部换成强化远古。数值、装备策略与验证边界见 [RUNTIME_FIXES_V38.md](docs/RUNTIME_FIXES_V38.md)。
