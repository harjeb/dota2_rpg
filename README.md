...
- **界面版本 42**：关卡掉落扩展为普通装备、散件、卷轴、消耗品、当前中立装备／附魔与肉山奖励，共 351 个源条目（349 种实际物品）；每关最多三件，不包含废弃／内部／测试定义。“再来一次”彻底清空旧进度，指挥官也重新创建，客户端草稿与库存一并清除。见 [RUNTIME_FIXES_V42.md](docs/RUNTIME_FIXES_V42.md)。
