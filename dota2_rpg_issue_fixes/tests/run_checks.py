...
LUA_SCENARIOS = (
    "native-shop-range.test.lua", "damage-stats.test.lua", "action-adapter.test.lua", "arena-trees.test.lua", "shop-state.test.lua",
...
def main() -> None:
    ...
    run([node, str(ROOT.parent / "tests/skill-debug.test.js")])
