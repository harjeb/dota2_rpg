...
function CDota2RpgDemo:InitGameMode()
	if RuntimeLog.StartSession ~= nil then RuntimeLog.StartSession("rpg-runtime-v38-20260911") end
	...
	RuntimeLog.Write("BUILD rpg-runtime-v38-20260911 loaded; log=console.log (-condebug)")
