...
function CDota2RpgDemo:InitGameMode()
	if RuntimeLog.StartSession ~= nil then RuntimeLog.StartSession("rpg-runtime-v27-20260910") end
	...
	RuntimeLog.Write("BUILD rpg-runtime-v27-20260910 loaded; log=console.log (-condebug)")
