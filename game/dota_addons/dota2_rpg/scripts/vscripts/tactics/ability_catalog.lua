-- Stable action identities: a hero may expose more than three spells and more
-- than one ultimate. Hidden sub-abilities remain configurable for later phases;
-- ActionAdapter checks whether they can actually execute at the current tick.
local Catalog = {}
