...
for(const lang of ['schinese','english']){
 ...
 assert(text.includes(lang==='english'?'"UI version 103"':'"界面版本 103"'));
...
console.log('PASS current 100-card catalog, native source contracts, empty initial state, UI103 locale parity');
