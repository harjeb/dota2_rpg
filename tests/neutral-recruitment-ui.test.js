...
const hero={hero_index:42,can_edit:true,neutral_recruitment:{'1':{source_name:'chen_holy_persuasion',source_level:2,max_level:4,max_count:2,allow_ancient:false,
...
console.log('PASS neutral recruitment UI: server eligibility, saved selection, explicit clearing, fight lock and stale results');
