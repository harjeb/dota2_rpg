...
local actorArgs={action_kind="ability",action_id="native_active",chase_timeout=120,max_chase_distance=2000,
...
check(saved.chase_timeout==120 and restored.chase_timeout==120 and restored.max_chase_distance==2000,"snapshot and legacy restore preserve chase settings")
