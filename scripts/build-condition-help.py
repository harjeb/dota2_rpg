...
('point', '地点伤害与区域控制', 'Point damage and area control', 'offensive_point',
 ...
 '不预测弹道、目标移动或落点安全。', 'No projectile, movement or safe-landing prediction.'),
('area', '范围伤害与控制', 'Area damage and control', 'aoe',
 '已审查的普通范围技能，在附近有敌人时按目标排序施放。', 'Reviewed ordinary area spells use target priorities when enemies are nearby.',
 '敌方；最近', 'Enemy; nearest', '自身800范围内敌人≥1', 'At least 1 enemy within 800 of caster', '按需要增加距离上限', 'Optionally limit distance',
 '附近敌人数以自身为中心观察，不表示技能作用范围或实际命中人数。技能仍受原生施法距离和目标限制。', 'Nearby enemies are observed around the caster; this is neither spell coverage nor a hit estimate. Native cast range and targeting checks still apply.'),
